/*!
 *  lessonWrite.jsp, lessonWrite.mobile.jsp, update.jsp, update.mobile.jsp  공통 스크립트
 */
/* jquery import */
...
$(document).ready(function(){
	/* 페이지 진입시 상단 서비스 탭 항목 제외하고 다른 탭 내용 숨기기 */
	...
	/* 상단 탭 클릭 이벤트 (ui효과, 내용 hide/show 처리) */
	...
	$('.btn1').click(function() {
		...
		var opt4price3 = document.getElementById('opt4price3');
		var cate1 = $('select[name=cate1]>option:selected').index();
		var cate2 = $('select[name=cate2]>option:selected').index();
		var cate3 = $('select[name=cate3]>option:selected').index();
		var cate4 = $('select[name=cate4]>option:selected').index();
		var opIdx2 = $('.service-cate0>option:selected').index();
		if (opIdx2 == 0) {
		...
		else if (cate1 != 0 && !check2(re2, opt1price3, "제공수업2의 가격을 숫자만 포함하여 입력해주세요.")) {
		} else if (cate1 != 0 && $('#opt1price3').val() > 2000000) {
			alert("수업가격은 최대 200만원을 넘을 수 없습니다. \n 제공수업2의 가격을 수정해주세요.")
		} else if (cate1 != 0 && $('#opt1price3').val() < 10000) {
			alert("수업가격은 최소 1만원을 이상입니다. \n 제공수업2의 가격을 수정해주세요.")
		} 
		
		else if (cate2 != 0 && !check2(re2, opt2price3, "제공수업3의 가격을 숫자만 포함하여 입력해주세요.")) {
		} else if (cate2 != 0 && $('#opt2price3').val() > 2000000) {
			alert("수업가격은 최대 200만원을 넘을 수 없습니다. \n 제공수업3의 가격을 수정해주세요.")
		} else if (cate2 != 0 && $('#opt2price3').val() < 10000) {
			alert("수업가격은 최소 1만원을 이상입니다. \n 제공수업3의 가격을 수정해주세요.")
		} 
		
		 else if (cate3 != 0 && !check2(re2, opt3price3, "제공수업4의 가격을 숫자만 포함하여 입력해주세요.")) {
		} else if (cate3 != 0 && $('#opt3price3').val() > 2000000) {
			alert("수업가격은 최대 200만원을 넘을 수 없습니다. \n 제공수업4의 가격을 수정해주세요.")
		} else if (cate3 != 0 && $('#opt3price3').val() < 10000) {
			alert("수업가격은 최소 1만원을 이상입니다. \n 제공수업4의 가격을 수정해주세요.")
		} 
		
		else if (cate4 != 0 && !check2(re2, opt4price3, "제공수업5의 가격을 숫자만 포함하여 입력해주세요.")) {
		} else if (cate4 != 0 && $('#opt4price3').val() > 2000000) {
			alert("수업가격은 최대 200만원을 넘을 수 없습니다. \n 제공수업5의 가격을 수정해주세요.")
	...
	$('.btn2').click(function() {
		...
		} else if (!check2(re1, lessonTitle, "제목을 30글자 내외로 작성해주세요.")) {} else {
			$('.menu td').eq(2).trigger('click');
		}
	})

	/* 수업정보 탭 메뉴 내용 validation */
	$('.btn3').click(function() {
	...
	/* 상단 서비스 메뉴의 제공수업1(필수) select박스 이벤트 */
	var ipsiOpts = '<option class="onlyIpsi">3회분</option><option class="onlyIpsi">2회분</option><option class="onlyIpsi">1회분</option>' // 제공수업 입시 선택시 수업 회분 1,2,3회분 옵션 추가
	$('.service-cate0').change(function() {
		$('.seg-cate0').find("select").each(function() {
			$(this).hide();
			$(this).attr("name", "");
		});

		var opIndex = $('.service-cate0>option:selected').index();
		if (opIndex == 0) {
			$('.price-standard0 > .onlyIpsi').remove();
			$('.seg-cate0').find("select").eq(opIndex).show();
		} else if (opIndex == 7) {
			$('.price-standard0').append(ipsiOpts);
			$('.seg-cate0').find("select").eq(opIndex).show();
			$('.seg-cate0').find("select").eq(opIndex).attr("name", "subCate0");
		} else {
			$('.price-standard0 > .onlyIpsi').remove();
			$('.seg-cate0').find("select").eq(opIndex).show();
			$('.seg-cate0').find("select").eq(opIndex).attr("name", "subCate0");
	...
	/* 상단 서비스 메뉴의 제공수업2(선택) select박스 이벤트 */
	$('.service-cate1').change(function() {
		$('.seg-cate1').find("select").each(function() {
			$(this).hide();
			$(this).attr("name", "");
		});

		var opIndex = $('.service-cate1>option:selected').index();
		if (opIndex == 0) {
			$('.price-standard1 > .onlyIpsi').remove();
			$('.seg-cate1').find("select").eq(opIndex).show();
		} else if (opIndex == 7) {
			$('.price-standard1').append(ipsiOpts);
			$('.seg-cate1').find("select").eq(opIndex).show();
			$('.seg-cate1').find("select").eq(opIndex).attr("name", "subCate1");
		} else {
			$('.price-standard1 > .onlyIpsi').remove();
			$('.seg-cate1').find("select").eq(opIndex).show();
			$('.seg-cate1').find("select").eq(opIndex).attr("name", "subCate1");
	...
	/* 상단 서비스 메뉴의 제공수업3(선택) select박스 이벤트 */
	$('.service-cate2').change(function() {
		$('.seg-cate2').find("select").each(function() {
			$(this).hide();
			$(this).attr("name", "");
		});

		var opIndex = $('.service-cate2>option:selected').index();
		if (opIndex == 0) {
			$('.price-standard2 > .onlyIpsi').remove();
			$('.seg-cate2').find("select").eq(opIndex).show();
		} else if (opIndex == 7) {
			$('.price-standard2').append(ipsiOpts);
			$('.seg-cate2').find("select").eq(opIndex).show();
			$('.seg-cate2').find("select").eq(opIndex).attr("name", "subCate2");
		} else {
			$('.price-standard2 > .onlyIpsi').remove();
			$('.seg-cate2').find("select").eq(opIndex).show();
			$('.seg-cate2').find("select").eq(opIndex).attr("name", "subCate2");
	...
	/* 상단 서비스 메뉴의 제공수업4(선택) select박스 이벤트 */
	$('.service-cate3').change(function() {
		$('.seg-cate3').find("select").each(function() {
			$(this).hide();
			$(this).attr("name", "");
		});

		var opIndex = $('.service-cate3>option:selected').index();
		if (opIndex == 0) {
			$('.price-standard3 > .onlyIpsi').remove();
			$('.seg-cate3').find("select").eq(opIndex).show();
		} else if (opIndex == 7) {
			$('.price-standard3').append(ipsiOpts);
			$('.seg-cate3').find("select").eq(opIndex).show();
			$('.seg-cate3').find("select").eq(opIndex).attr("name", "subCate3");
		} else {
			$('.price-standard3 > .onlyIpsi').remove();
			$('.seg-cate3').find("select").eq(opIndex).show();
			$('.seg-cate3').find("select").eq(opIndex).attr("name", "subCate3");
	...
	/* 상단 서비스 메뉴의 제공수업5(선택) select박스 이벤트 */
	$('.service-cate4').change(function() {
		$('.seg-cate4').find("select").each(function() {
			$(this).hide();
			$(this).attr("name", "");
		});

		var opIndex = $('.service-cate4>option:selected').index();
		if (opIndex == 0) {
			$('.price-standard4 > .onlyIpsi').remove();
			$('.seg-cate4').find("select").eq(opIndex).show();
		} else if (opIndex == 7) {
			$('.price-standard4').append(ipsiOpts);
			$('.seg-cate4').find("select").eq(opIndex).show();
			$('.seg-cate4').find("select").eq(opIndex).attr("name", "subCate4");
		} else {
			$('.price-standard4 > .onlyIpsi').remove();
			$('.seg-cate4').find("select").eq(opIndex).show();
			$('.seg-cate4').find("select").eq(opIndex).attr("name", "subCate4");
...
function checkLesson(member) {
	...
	if (cate1 != 0 && !check2(re2, opt1price3, "제공수업2의 가격을 숫자만 포함하여 입력해주세요.")) {
		$('.menu td:first').trigger('click');
		return false;
	}

	if (cate1 != 0 && $('#opt1price3').val() > 2000000) {
		alert("수업가격은 최대 200만원을 넘을 수 없습니다. \n 제공수업2의 가격을 수정해주세요.");
		$('.menu td:first').trigger('click');
		return false;
	}
	if (cate1 != 0 && $('#opt1price3').val() < 10000) {
		alert("수업가격은 최소 1만원을 이상입니다. \n 제공수업2의 가격을 수정해주세요.");
		$('.menu td:first').trigger('click');
		return false;
	}

	if (cate2 != 0 && !check2(re2, opt2price3, "제공수업3의 가격을 숫자만 포함하여 입력해주세요.")) {
		$('.menu td:first').trigger('click');
		return false;
	}

	if (cate2 != 0 && $('#opt2price3').val() > 2000000) {
		alert("수업가격은 최대 200만원을 넘을 수 없습니다. \n 제공수업3의 가격을 수정해주세요.");
		$('.menu td:first').trigger('click');
		return false;
	}

	if (cate2 != 0 && $('#opt2price3').val() < 10000) {
		alert("수업가격은 최소 1만원을 이상입니다. \n 제공수업3의 가격을 수정해주세요.");
		$('.menu td:first').trigger('click');
		return false;
	}
	
	if (cate3 != 0 && !check2(re2, opt3price3, "제공수업4의 가격을 숫자만 포함하여 입력해주세요.")) {
		$('.menu td:first').trigger('click');
		return false;
	}

	if (cate3 != 0 && $('#opt3price3').val() > 2000000) {
		alert("수업가격은 최대 200만원을 넘을 수 없습니다. \n 제공수업4의 가격을 수정해주세요.");
		$('.menu td:first').trigger('click');
		return false;
	}

	if (cate3 != 0 && $('#opt3price3').val() < 10000) {
		alert("수업가격은 최소 1만원을 이상입니다. \n 제공수업4의 가격을 수정해주세요.");
		$('.menu td:first').trigger('click');
		return false;
	}

	if (cate4 != 0 && !check2(re2, opt4price3, "제공수업5의 가격을 숫자만 포함하여 입력해주세요.")) {
		$('.menu td:first').trigger('click');
		return false;
	}

	if (cate4 != 0 && $('#opt4price3').val() > 2000000) {
		alert("수업가격은 최대 200만원을 넘을 수 없습니다. \n 제공수업5의 가격을 수정해주세요.");
		$('.menu td:first').trigger('click');
		return false;
	}

	if (cate4 != 0 && $('#opt4price3').val() < 10000) {
		alert("수업가격은 최소 1만원을 이상입니다. \n 제공수업5의 가격을 수정해주세요.");
		$('.menu td:first').trigger('click');
		return false;
	}
