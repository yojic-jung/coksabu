				...
				<div style="list-style:none;width:100%; ">    
                  ...
                  <!-- 선생님 소개 -->
                    ...
                    <div style="font-size:35px;" >
                    	...
                    	<img id="output" style="width:400px; height:400px;" src="<c:url value="/resources/profileImg/pro.png"  />"  alt="레슨대표이미지"/>
                        <br/>
...
<label for="save" style="background: orange; color: white;;padding:10px; border-radius:10px;">동의하고 레슨 만들기</label>
                    <input id="save" class="save btn" type="submit" value="동의하고 레슨 만들기"/> 
                  </div>
                  </div>	
