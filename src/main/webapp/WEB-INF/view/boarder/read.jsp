				...
				<div style="margin:10px 0px;;">구매옵션</div>
					<table class="price-table">
						...
						<tr>
							<td>
							<div class="highlight">
							<div class="price-sub"><label><input type="radio" name="subCate" value="fourth"/> ${lesson.subCate3} &nbsp; ${lesson.opt3price3}원</label></div>
						...
						<tr>
							...
							<div class="price-sub"><label><input type="radio" name="subCate" value="fifth"/> ${lesson.subCate4} &nbsp; ${lesson.opt4price3}원</label></div>
							<div class="price-content">수업횟수 : ${lesson.opt4price1}<br/>회당 수업시간 : ${lesson.opt4price2}</div>
							</div>
							</td>
						</tr>
						</c:if>
