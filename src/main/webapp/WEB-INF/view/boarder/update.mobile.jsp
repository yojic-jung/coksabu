...
<body>
		...
		<form:form commandName="card" method="post" enctype="multipart/form-data" onSubmit="return checkLesson(this)">
			...
			<div class="teacher-intr">
				<div style="margin-top: 20px; line-height: 180%;">
					...
					<table class="lesson-table" style="width: 100%; border-spacing: 0px 20px;">
						...
						<tr>
							...
							<td>
								<input name="price3" style="text-align: right;" class="price-pri1" type="text" id="price3" placeholder="숫자만 입력" value="${lesson.price3}"/> 원
							</td>
						</tr>


						<tr>
							<td colspan="3">제공수업2(선택)</td>
						</tr>
						<tr>
							<td colspan="3">
						...
						<tr>
							...
							<td>
								<input name="opt1price3" style="text-align: right;" class="price-pri1" type="text" id="opt1price3" placeholder="숫자만 입력" value="${lesson.opt1price3}" /> 원
							</td>
						</tr>

						<tr>
							<td colspan="3">제공수업3(선택)</td>
						</tr>
						<tr>
							<td colspan="3">
						...
						<tr>
							...
							<td>
								<input name="opt2price3" style="text-align: right;" class="price-pri1" type="text" id="opt2price3" placeholder="숫자만 입력"  value="${lesson.opt2price3}"/> 원
							</td>
						</tr>

						<tr>
							<td colspan="3">제공수업4(선택)</td>
						</tr>
						<tr>
							<td colspan="3">
						...
						<tr>
							...
							<td>
								<input name="opt3price3" style="text-align: right;" class="price-pri1" type="text" id="opt3price3" placeholder="숫자만 입력" value="${lesson.opt3price3}"/> 원
							</td>
						</tr>
						...
						<tr>
							...
							<td>
								<input name="opt4price3" style="text-align: right;" class="price-pri1" type="text" id="opt4price3" placeholder="숫자만 입력"  value="${lesson.opt4price3}"/> 원
							</td>
						</tr>
				...
				<div>
					<div class="service-table">
						<div style="font-size: 35px; text-align: center; margin-top: 30px;">
							<label>
			...
			<div class="teacher-intr">
				<div>
					수업 대표 이미지
					<br />
					<span style="color: gray; font-size: 40px; margin: 15px 0px 15px 0px;">수업을 대표하는 이미지나 선생님 사진을 넣어주세요.</span>
					<br />
				...
				<div>
					...
					<span style="color: gray; font-size: 40px;">
						제목을 30글자 미만으로 적어주세요.(
			...
			<div class="teacher-intr">
				...
				<span style="color: gray; font-size: 35px;">경력이 없으신 경우 생략가능합니다.</span>
				<br />
	...
	<script src="<c:url value="resources/js/boarder/lessonWriteAndUpdate.js?v=1" />"></script>
	<script>
