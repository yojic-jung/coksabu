...
.price-standard, .price-time, .price-standard2, .price-time,
	.price-time2, .price-pri {
	font-size: 18px;
	padding: 7px;
	height: 40px;
}
...
<body>
	<div style="list-style: none; background: rgb(63, 63, 61); padding: 0px;">
		<div>
			<span style="float: left; clear: right; font-size: 20px; padding: 15px;"> <a href="./tutorpage" style="color: white; text-decoration: none;">&lt;뒤로가기</a></span>
		...
		<form:form commandName="card" method="post" enctype="multipart/form-data" onSubmit="return checkLesson(this)">
			...
			<div class="teacher-intr">
				<div style="margin-top: 20px; line-height: 180%;">
					선생님의 재능을 마음껏 펼쳐보세요!<br /> 많은 수업을 등록 할수록 많은 학생들에게 선생님의 수업이 노출 됩니다.
					...
					<table style="width: 100%; border-spacing: 0px 20px;">
						...
						<tr>
							...
							<td class="seg-cate0">
								<select style="font-size: 15px; padding: 7px; height: 40px; width: 130px; display: inline-block" disabled>
						...
						<tr>
							...
							<td>
								<input name="opt1price3" style="text-align: right;; padding: 7px; width: 130px; font-size: 15px;" class="price-pri1" type="text" id="opt1price3" placeholder="숫자만 입력"  value="${lesson.opt1price3}"/>원
							</td>
						</tr>
						...
						<tr>
							...
							<td>
								<input name="opt2price3" style="text-align: right;; padding: 7px; width: 130px; font-size: 15px;" class="price-pri1" type="text" id="opt2price3" placeholder="숫자만 입력" value="${lesson.opt2price3}" />원
							</td>
						</tr>
						...
						<tr>
							...
							<td>
								<input name="opt3price3" style="text-align: right;; padding: 7px; width: 130px; font-size: 15px;" class="price-pri1" type="text" id="opt3price3" placeholder="숫자만 입력"  value="${lesson.opt3price3}"/>원
							</td>
						</tr>
						...
						<tr>
							...
							<td>
								<input name="opt4price3" style="text-align: right;; padding: 7px; width: 130px; font-size: 15px;" class="price-pri1" type="text" id="opt4price3" placeholder="숫자만 입력"  value="${lesson.opt4price3}"/>원
							</td>
						</tr>
				...
				<div class="service-table">
					<div style="font-size: 15px; text-align: center; margin:80px 0;">
			...
			<div class="teacher-intr">
				<div>
					수업 대표 이미지<br /> <span style="color: gray; font-size: 18px; margin: 15px 0px 15px 0px;">수업을 대표하는 이미지나 선생님 사진을 넣어주세요.</span> <br /> <img id="output" style="width: 240px; height: 240px;" src="<c:url value="/img/representImg/${lesson.represent}" />" alt="수업대표이미지" /> <br />
				...
				<div>
					<br /> 제목<br /> <span style="color: gray; font-size: 18px;">제목을 30글자 미만으로 적어주세요.(<span class="title-length">0</span>/30)
					</span><br /> <input name="title" type="text" id="lesson-title" style="margin-top: 10px; width: 570px; padding: 7px; font-size: 18px;" placeholder="수업제목을 30자 내외로 적어주세요." value="${lesson.title}" />
				</div>
				<div>
					<br /> <br />
			...
			<!-- 수업 소개 -->
			<div class="teacher-intr">
				수업 가능 요일 <br /> <span style="color: gray; font-size: 18px; margin-top: 10px;"> <label style="cursor: pointer"><input type="checkbox" name="day" value="월" /> 월</label> &nbsp; <label style="cursor: pointer"><input type="checkbox" name="day" value="화" /> 화</label> &nbsp; <label style="cursor: pointer"><input type="checkbox" name="day" value="수" /> 수 </label>&nbsp; <label style="cursor: pointer"> <input type="checkbox" name="day" value="목" /> 목
				...
				</label>&nbsp; <label style="cursor: pointer"><input type="checkbox" name="day" value="일" /> 일</label></span> <br /> <br /> 수업 형태<br /> <span style="color: gray; font-size: 18px; margin-top: 10px;"> <label style="cursor: pointer"><input type="checkbox" name="gawe" value="개인 과외 가능" /> 개인 과외 가능 </label>&nbsp; <label style="cursor: pointer"><input type="checkbox" name="gawe" value="화상 과외 가능" /> 화상 과외 가능</label></span> <br /> <br /> 시범수업<br /> <span style="color: gray; font-size: 18px; margin-top: 10px;"> <label style="cursor: pointer"><input type="checkbox" name="trial" class="free" value="시범수업 무료" /> 시범수업 무료</label></span> <br /> <br /> 수업 소개 <br /> <span style="color: gray; font-size: 18px; margin-top: 10px">수업 형태나 학습목표, 커리큘럼에 대해 자세히 적어주세요.(<span class="lesson-length">0</span>/500)
				</span>
			...
			<div class="teacher-intr" id="teacher-intr">
				...
				<br />
				<div class="btn-div">
					<span class="prev6 btn">이전단계</span> <input class="save btn" type="submit" value="수정하기" />
				</div>
			</div>
	...
	<script>
		$(document).ready(function() {
			...
			var cate0Idx = $(".service-cate0 option").index( $(".service-cate0 option:selected") );
			var cate1Idx = $(".service-cate1 option").index( $(".service-cate1 option:selected") );
			var cate2Idx = $(".service-cate2 option").index( $(".service-cate2 option:selected") );
			var cate3Idx = $(".service-cate3 option").index( $(".service-cate3 option:selected") );
			var cate4Idx = $(".service-cate4 option").index( $(".service-cate4 option:selected") );
			...
			$('.seg-cate0 > select').eq(cate0Idx).val(subCate0).attr("selected", true);
			$('.seg-cate1 > select').eq(cate1Idx).val(subCate1).attr("selected", true);
			$('.seg-cate2 > select').eq(cate2Idx).val(subCate2).attr("selected", true);
			$('.seg-cate3 > select').eq(cate3Idx).val(subCate3).attr("selected", true);
			$('.seg-cate4 > select').eq(cate4Idx).val(subCate4).attr("selected", true);
			...
			$('select[name=price1]').val(price1).prop("selected", true);
			$('select[name=opt1price1]').val(opt1price1).prop("selected", true);
			$('select[name=opt2price1]').val(opt2price1).prop("selected", true);
			$('select[name=opt3price1]').val(opt3price1).prop("selected", true);
			$('select[name=opt4price1]').val(opt4price1).prop("selected", true);
			...
			$('select[name=price2]').val(price2).prop("selected", true);
			$('select[name=opt1price2]').val(opt1price2).prop("selected", true);
			$('select[name=opt2price2]').val(opt2price2).prop("selected", true);
			$('select[name=opt3price2]').val(opt3price2).prop("selected", true);
			$('select[name=opt4price2]').val(opt4price2).prop("selected", true);
			
			var priNegotiation = "<c:out value="${lesson.priNegotiation}" />";
			$('input[name=priNegotiation]').each(function(idx, item) {
				if ($(this).val() == priNegotiation) {
					$(this).attr("checked", true);
					$(this).closest("div").addClass('radio-back');
				}
			})
