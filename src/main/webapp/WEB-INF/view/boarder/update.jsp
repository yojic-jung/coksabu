                  ...
                  <!-- 선생님 소개 -->
                    <div class="teacher-intr" >
                        ...
                        <div style="margin-top:20px;line-height:180%;">
                          	서비스 카테고리<br/>
                          	 <span style="margin-bottom:5px;font-size:18px;"> ※카테고리별 가격이 다르다면 레슨을 별도로 만드시기 바랍니다.</span><br/>
					...
					<c:if test="${lesson.represent == null}" >
                    	<img id="output" style="width:240px; height:240px;" src="<c:url value="/resources/representImg/pro.png"  />"  alt="레슨대표이미지"/>
                    </c:if>
                    <c:if test="${lesson.represent != null }">
                        <img id="output" style="width:240px; height:240px;" src="<c:url value="/img/representImg/${lesson.represent}" />"  alt="레슨대표이미지"/>
                   	</c:if>
                        <br/>
