...
<div style="text-align:center;margin:40px;color:orange;font-size:30px;">선생님과 상담하기</div>

<div style="font-size:24px;margin:40px auto;width:70%;text-align:center;"><b>선생님에게 상담하고 싶은 사항 또는 궁금사항을 적어주세요.</b></div>
<form method="post" onSubmit="return checkLesson(this)">
<div style="color:dimgray;font-size:25px;width:70%;margin:40px auto;text-align:center;">메시지(100자 내외, <span class="title-length">0</span>/100)</div>
<div style="text-align:center;">

<textarea id="lesson-title" style="font-size:24px; line-height:150%;" rows="6" cols="30" name="message"></textarea>
</div>
<div style="text-align:center;width:70%;margin:10px auto;line-height:150%;font-size:24px;color:gray;">
...
<input type="submit" style="border-radius:10px;font-size:24px; padding:10px; background:orange; color:white;" value="상담신청하기" />
</div>
 </form>
