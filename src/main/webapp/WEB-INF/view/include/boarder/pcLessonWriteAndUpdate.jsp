...
<form:form commandName="card" method="post" enctype="multipart/form-data" onSubmit="return checkLesson(this)">
	...
	<div class="teacher-intr">
		<div style="margin-top: 20px; line-height: 180%;">
			...
			<table class="lesson-table" style="border-spacing: 20px 30px; margin:30px auto 100px auto;">
				...
				<tr>
					<td>
						<select name="price1" class="price-standard0" style="font-size: 15px; padding: 7px; height: 40px;">
				...
				<tr>
					<td style="font-size: 15px; color: orange; font-weight: bold;">제공수업2(선택)</td>
				</tr>
				<tr>
					<td>
				...
				<tr>
					<td>
						<select name="opt1price1" class="price-standard1" style="font-size: 15px; padding: 7px; height: 40px;">
							<option>한달 12회</option>
							<option>한달 8회</option>
							<option>한달 4회</option>
						</select>
				...
				<tr class="opt2-tr">
					<td style="font-size: 15px; color: orange; font-weight: bold;">제공수업3(선택)</td>
				</tr>
				<tr class="opt2-tr">
					<td>
				...
				<tr class="opt3-tr">
					<td>
						<select name="opt3price1" class="price-standard3" style="font-size: 15px; padding: 7px; height: 40px;">
							<option>한달 12회</option>
							<option>한달 8회</option>
							<option>한달 4회</option>
						</select>
				...
				<tr class="opt4-tr">
					<td style="font-size: 15px; color: orange; font-weight: bold;">제공수업5(선택)</td>
				</tr>
				<tr class="opt4-tr">
					<td>
				...
				<tr class="opt4-tr">
					<td>
						<select name="opt4price1" class="price-standard4" style="font-size: 15px; padding: 7px; height: 40px;">
							<option>한달 12회</option>
							<option>한달 8회</option>
							<option>한달 4회</option>
						</select>
	...
	<div class="teacher-intr" id="teacher-intr">
		...
		<div class="btn-div">
			...
			<c:choose>
				<c:when test="${fn:contains(uri, 'update')}">
					<input class="save btn" type="submit" value="수정하기" />
				</c:when>
				<c:otherwise>
