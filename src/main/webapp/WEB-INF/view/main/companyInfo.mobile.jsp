...
<link rel="stylesheet" href= "<c:url value="/resources/css/companyInfoM.css" />" />
...
<span style="padding:10px; border-bottom:1px solid orange;">수업목록, 수업요청</span><br/><br/>
...
<div style=" background-color:rgb(238, 238, 236);font-size:30px;padding:120px 120px 360px 120px; text-align:center;margin-bottom:50px;">
<div>"지금 원하는 수업을 찾아보세요."</div><br/><br/>
<span style="border-radius:15px; width:30%; padding:30px;background:orange;font-size:30px;"><a href="./boarder?main=11&subject=11" style="text-decoration:none; color:white;"><b>수업 목록</b></a></span>
