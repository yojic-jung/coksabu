...
<div>"지금 원하는 레슨을 찾아보세요."</div><br/><br/>
<span style="border-radius:15px; width:30%; padding:30px;background:orange;font-size:30px;"><a href="./boarder?main=11&subject=11" style="text-decoration:none; color:white;"><b>레슨 찾기</b></a></span>
