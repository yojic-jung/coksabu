...
min-height:300px;
 ...
 padding:5px; background:black;color:white;font-size:40px;cursor:pointer
  ...
  .teacher-guide-close{
 	 font-size:40px;cursor:pointer; text-decoration:underline;
 }
.teacher-content{
 	width:80%;
 	margin:40px auto;
...
<div style="min-height:300px;font-size:40px;padding:50px 0px;">
	<div class="teacher-content">
		...
		'안전거래' 기능과 '환불제도'는 학생 학부모님에게 <br/>
		과외플랫폼에서도 안전한 거래가 가능하다는 신뢰감을 드리고<br/>
		보다 많은 학생 학부모 회원을 유입시키고자<br/>
		...
		<div style="font-size:40px;">
		<div style="color:orange;font-weight:bolder;padding:50px 0px 50px 0px;">&#9312; &nbsp;최대 5개 과목의 수업 홍보 가능</div>
		...
		수업은 총 5개 과목까지 만들수 있으며 수업이 노출되기 위해서는 '본인인증'과 '학력인증'은 필수 입니다.<br/>
		...
		<div style="color:orange;font-weight:bolder;margin:150px 0px 50px 0px;">&#9313; &nbsp;채팅창의 '거래 제안서 작성'</div>
		<div>
		...
		<br/>
		과외는 학생의 요구조건 따라 수업형식과 수업가격이 천차만별 달라질 수 있어 <br/> 
		...
		<div style="font-size:40px;">
		<div style="color:orange;font-weight:bolder;margin:150px 0px 50px 0px;">&#9314; &nbsp;학생의 수업 요청에 지원서 작성</div>
...
<script>
	$(document).ready(function(){
		...
		$('.m-nav-mypage').css('color','orange');
		$('.m-nav-category').css('color','gray');
		$(".m-nav-cate-img").attr("src", "./resources/img/cate.png");
		$(".m-nav-mypage-img").attr("src", "./resources/img/my2.png");
