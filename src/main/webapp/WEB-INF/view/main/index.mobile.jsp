...
<body>
	...
	<div class="cok-intro">
		<div class="intro-title">
			<span class="intro-close1">[하루동안 열지않음 X]</span> . <span class="intro-close2">[닫기 X]</span>
		</div>
		<div class="intro-content">
			<div style="width: 90%; margin: 70px auto 100px auto; font-size: 55px;">
				콕사부에 대해 알아보고<br />과외수업을 진행해보세요.
			</div>
			...
			<div class="teach-text1">
				...
				<div style="width: 80%; margin: 30px auto;">콕사부 선생님은 최대 3개의 수업을 무료로 만들어 홍보 할 수 있습니다.</div>
			...
			<div class="teach-text4">
				<div style="width: 80%; margin: 30px auto;">
					콕사부는 선생님들이 중개수수료와 유료 이용료 없이 과외를 구할 수 있도록 하였습니다.<br /> 콕사부에서 자유롭게 과외활동을 해보세요.
				</div>
				...
				<div class="naver-customize">
					<span style="font-weight: bolder; float: left; clear: right;"> <img src="<c:url value='/resources/img/naver.png' />" style="width: 80px; height: 80px;" />
					</span> 네이버로 로그인
				</div>
			...
			<div class="student-text1">
				...
				<div style="width: 80%; margin: 30px auto;">
					수업목록을 통해 구체적인 선생님 정보와 수업정보를 알 수 있으며,<br /> 성별, 경력, 과외가능위치 등 상세검색을 통해 원하는 선생님을 찾을 수 있습니다.
				</div>
			...
			<div class="student-text2">
				...
				<div style="width: 80%; margin: 30px auto;">
					선생님을 직접 찾지 않더라고 과외요청서를 작성하면,<br /> 수업 가능한 선생님의 지원서를 받아 볼 수 있습니다.
				</div>
			...
			<div class="student-text3">
				...
				<div style="width: 80%; margin: 30px auto;">
					채팅을 통하여 안전하게 상담 또한 진행 할 수 있으니,<br /> 지금 콕사부를 통해 과외선생님을 만나보세요!
				</div>
	...
	<section>
		...
		<div style="text-align: center; font-family: 'JejuGothic'; padding: 30px; background: #F6F6F6">
			...
			<div style="margin: 30px;">
				<a href="./useGuide" style="text-decoration: none; color: white;">
					<span style="padding: 10px; border-radius: 10px; background: orange; font-size: 40px;">"콕사부 이용가이드"</span>
				</a>
			</div>
		</div>
				...
				<tr>
					<td>
						<a href="./boarder?main=11&subject=11">
							<img src="<c:url value="/resources/images/ui1m.png" />" style="width: 100%; height: 120px;" alt="1" />
						</a>
					</td>
					<td>
						<a href="./boarder?main=21&subject=21">
							<img src="<c:url value="/resources/images/ui2m.png" />" style="width: 100%; height: 120px;" alt="1" />
						</a>
					</td>
					<td>
						<a href="./boarder?main=31&subject=31">
							<img src="<c:url value="/resources/images/ui3m.png" />" style="width: 100%; height: 120px;" alt="1" />
						</a>
					</td>
					<td>
						<a href="./boarder?main=41&subject=41">
							<img src="<c:url value="/resources/images/ui4m.png" />" style="width: 100%; height: 120px;" alt="1" />
						</a>
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td>
						<a href="./boarder?main=51&subject=51">
							<img src="<c:url value="/resources/images/ui5m.png" />" style="width: 100%; height: 120px;" alt="1" />
						</a>
					</td>
					<td>
						<a href="./boarder?main=61&subject=62">
							<img src="<c:url value="/resources/images/ui6m.png" />" style="width: 100%; height: 120px;" alt="1" />
						</a>
					</td>
					<td>
						<a href="./boarder?main=61&subject=64">
							<img src="<c:url value="/resources/images/ui7m.png" />" style="width: 100%; height: 120px;" alt="1" />
						</a>
					</td>
					<td>
						<a href="./boarder?main=71&subject=71">
							<img src="<c:url value="/resources/images/ui8m.png" />" style="width: 100%; height: 120px;" alt="1" />
						</a>
					</td>
				</tr>
				<tr>
	...
	<div class="tutorial-first">
		<div class="tutorial-para">
			<div class="tutorial-first-title">
				튜토리얼 안내를 통해<br />쉽고 빠르게 시작해보세요
			</div>
			<div class="tutorial-first-content">
				친절한 사용 설명과 함께 쉽고 빠르게<br /> 콕사부 서비스를 사용할 수 있습니다
			</div>
		</div>
		<br />
		<div>
