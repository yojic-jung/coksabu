...
$(document).on("click","a",function(event){
	...
	if(broswerInfo.indexOf("APP_WISHROOM_IOS")>-1 || broswerInfo.indexOf("APP_WISHROOM_Android")>-1){
        ...
        $('.m-page-transit').show();
        $('.m-page-transit').animate({
        	left:0
        }, 200);
        setTimeout(function(){redirectPage()}, 400);
	}
});
...
<div class="m-page-transit" style="text-align:center;width:100%;background: white; height:100%;position:fixed;left:100%;top:0px;z-index:10;display:none;">
    <img src="<c:url value="/resources/img/Spin-1s-124px.svg" />"  style="margin-top:50%;"/>
</div>
<div class="m-back-transit" style="text-align:center;width:100%;background: white; height:100%;position:fixed;right:100%;top:0px;z-index:10;display:none;">
    <img src="<c:url value="/resources/img/Spin-1s-124px.svg" />"  style="margin-top:50%;"/>
</div>
<decorator:body />
