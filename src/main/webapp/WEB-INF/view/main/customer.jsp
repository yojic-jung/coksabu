...
<div>고객센터</div>
	...
	<div class="qa">
	<div class="first-q">Q. 콕사부 선생님 '수수료' 및 '이용료'는 어떻게 되나요?</div>
	<div class="first-a">
		콕사부는 과외 중개수수료 및 유료 이용료 없이 서비스를 이용하는 모든 사용자가 무료로 이용할 수 있습니다.<br/>
		다만, 콕사부 내의 안전거래를 통한 거래가 일어나는 경우  수업료의 5%가 안전결제 서비스 사용료로 부과 됩니다.<br/>
		직거래를 하는 경우에는 어떠한 비용도 청구되지 않으며 직거래를 한다고 해서 페널티가 주어지지도 않습니다.<br/>
		(직거래를 통한 사기 유도, 허위 광고, 상대에게 불쾌감을 주는 직거래 유도, 기타 불순한 목적으로 사용되는 경우에는 이용제한, 회원정지 등의 페널티가 주어짐.)<br/>
		안전거래 시스템 정책에 따라 수업비는 수업이 종료되는 날짜를 기준으로 1-3일 후 안전결제 서비스 사용료 5% 제외 후
		수업비가 전달됩니다.<br/>
	</div>
	</div>
...
다만, 콕사부는 수업종료 후 콕사부가 보관하는 수업비를 선생님에게 전달하므로<br/>
수업종료 후에 환불 신청을 할 경우, 거래 당사자인 선생님과 환불 절차를 진행해야함을 알려드립니다.
</div>
	</div>
	</div>
</div>
