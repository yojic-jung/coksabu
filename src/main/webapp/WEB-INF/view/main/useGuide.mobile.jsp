...
<div style="min-height:300px;font-size:40px;padding:100px 0px;">
	...
	<div class="teacher-content">
		...
		전달하는 방식입니다.(수수료는 과외금액의 20%, 수수료는 이벤트 및 프로모션 상황 따라 다르게 적용 받을 수 있습니다.)
		<br/>
		...
		<div class="subtile" style="clear:left;">'수수료'는 어떻게 되나요?</div>
		<div style="font-size:40px;">
		콕사부는 거래가 발생하는 경우에 과외비의 20%의 수수료가 발생합니다. 이외의 별도 서비스 이용료는 없습니다.<br/> 
		수수료는 이벤트 및 프로모션 상황 따라 다르게 적용 받을 수 있습니다.<br/>
		콕사부 내의 거래를 이용하는 경우 과외비의 20%인 수수료를 제외하고 과외비를 선생님에게 전달해드리며,
		만일 콕사부 내에서 거래하지 않고 직거래를 한 경우에도 수수료를 회사로 자진 납부 하셔야합니다.
		이를 어길시 수수료의 10배에 해당하는 금액 위약금으로 배상해야합니다.
		</div>
	</div>
</div>
