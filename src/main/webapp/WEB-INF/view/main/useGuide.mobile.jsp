...
<meta charset="utf-8">
<meta name="description" content="콕사부 이용가이드 페이지입니다." />
...
min-height:450px;
 ...
 padding:5px; background:black;color:white;font-size:40px;cursor:pointer
 }
 .student-guide-close,  .teacher-guide-close{
 	display:none; font-size:40px;cursor:pointer; text-decoration:underline;
 }
...
<div style="min-height:300px;font-size:40px;background-color:rgb(238, 238, 236);padding:100px 0px">
	<div style="text-align:center;font-size:35px;">
		<span style="padding:10px; border-bottom:1px solid orange;font-size:45px;">학생/학부모 이용가이드</span><br/><br/><br/>
		학생/학부모 회원을 위한 서비스 안내 및 사용 안내 입니다. 
		<br/><br/><br/>
		<span class="student-guide">내용 펼치기  &xdtri;</span>
		<span class="student-guide-close">내용 닫기 &xutri;</span>
	</div>
	<div class="student-content">
		<div style="line-height:200%;font-weight:bolder;color:orange;text-align:center;">"콕사부는 선생님의 신원 및 학력 인증 절차를 진행하며,<br/>콕사부 내의 모든 수업에 대해 환불정책과 안전거래 시스템을 제공합니다."</div>
		...
		<div>
		콕사부는 선생님들의 '본인인증' 및 '학력인증'을 진행하고 있습니다. <br/>
		인증이 검증된 선생님의 경우 선생님의 수업카드에 '본인인증 및 학력인증 완료' 라는 내용을 포함한 문구를 넣어 검증 된 선생님을 밝히고 있습니다.<br/>
		</div>
		...
		<div style="color:orange;font-weight:bolder">방법 &#9313; &nbsp;수업요청서를 작성하여 수업가능한<br/> 선생님 지원서 받기</div>
		...
		<div class="subtile">채팅창의 '거래 제안서 작성' 기능은<br/>무엇인가요??</div>
		<div>
...
<div style="min-height:300px;font-size:40px;padding:100px 0px;">
	<div style="text-align:center;font-size:35px;">
		<span style="padding:10px; border-bottom:1px solid orange;font-size:45px;">선생님 이용가이드</span><br/><br/><br/>
		선생님 회원을 위한 서비스 안내 및 사용 안내 입니다. 
		<br/><br/><br/>
	...
	<div class="teacher-content">
		...
		수업은 총 5개 과목까지 만들수 있으며 수업이 정상적으로 노출되기 위해 '본인인증'과 '학력인증'을 해주시기 바랍니다.<br/>
		'본인인증'과 '학력인증'을 하지 않아도 수업이 노출되지만, 인증을 진행한 선생님들이 상위 노출되며, 인증을 진행하지 않은 선생님들은 그 이후 하위 노출이 됩니다.<br/>
		...
		<img class="find" src="<c:url value="/resources/img/teacherway.png" />"  alt="수업찾기1"/>
		<br/>
		...
		<div class="subtile" style="clear:left">'본인인증', '학력인증'은 필수 인가요?</div>
		<div style="font-size:40px;">
		<img class="find" src="<c:url value="/resources/img/identifyway.png" />"  alt="수업찾기1"/>
		<br/>
		'본인인증'과 '학력인증'의 경우 필수사항은 아니지만 인증을 진행하지 않으면 서비스 사용에 제약이 있습니다.<br/> 
		인증을 진행한 선생님의 수업이 상위노출 되며 인증이 진행되지 않은 선생님 수업은 하위노출 됩니다.<br/>
		또한 학생의 과외요청에 응답 할 수 없는 등 서비스 사용에 제약이 있습니다.
		</div>

		<div class="subtile" style="clear:left;">'안전거래'는 무엇인가요??</div>
		<div style="font-size:40px;">
		안전거래는 학생이 수업금액을 선생님에게 입금하지 않고 콕사부 회사로 입금하고 
		이를 회사가 보관하고 수업이 종료되는 날짜를 기준으로 1-3일 이후 선생님에게 안전결제 서비스 사용료(판매금액의 5%) 제외하고
		전달하는 방식입니다
		<br/>
		콕사부 내의 모든 거래는 안전거래 정책에 따라 진행됩니다.
		</div>
		
		<div class="subtile" style="clear:left;">'수수료'및 '이용료' 어떻게 되나요?</div>
		<div style="font-size:40px;">
