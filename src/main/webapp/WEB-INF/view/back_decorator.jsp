...
<noscript>
	<img height="1" width="1" style="display: none" src="https://www.facebook.com/tr?id=2787801881458923&ev=PageView&noscript=2" />
</noscript>
...
<body>
	<c:if test="${currentDevice.mobile}">
		<%@ include file="/WEB-INF/view/include/mHeader3.jsp"%>
