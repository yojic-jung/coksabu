...
@charset "UTF-8";
        ...
        .bar7{
        width:95%; background:rgb(44, 184, 26); border-radius:4px;padding:4px;
        }
	...
	.prev2, .prev3, .prev4, .prev5, .prev6, .prev7, .prev8{
		text-align:center;
		border-top:5px solid #EF904F;
		background:white;
		color: #EF904F;
	...
	.locale3{
	display:none;font-size:40px; color:gray; padding:30px;width:80%;
	}
	...
	.permit{
            font-size:40px; padding:20px;width:90%;
     }
...
<% } %>
        <section>
            ...
            <div style="line-height:150%;text-align:center;">
            	...
            	<span style="color:orange;font-weight:bolder">"아래 이메일과 비밀번호를 바르게 입력해주세요.<br/>
            	회원님의 로그인 정보입니다."</span>
            </div>
            <br/>
            <br/>
            <table class="catetable" style="font-size:40px;">
    		...
    		<tr><td>
    		<table style="border:1px solid rgb(209, 209, 209);width:80%;margin:10px auto;border-spacing:0px;border-radius:5px;">
   				<tr>
    				<td style="background:rgb(209, 209, 209);padding:10px;font-size:30px;">휴대폰 인증하기</td>
    			</tr>
   				<tr>
    				<td>
    					<div style="font-size:30px; padding:10px;">본인명의 휴대폰 인증만 가능합니다.</div>
   			...
   			<tr><td>
    		<div style="margin :0px auto;font-size:35px;">
