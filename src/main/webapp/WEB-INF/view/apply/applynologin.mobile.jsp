...
padding: 5px;
	...
	.btn1, .btn2, .btn3, .btn4 , .btn5, .btn6, .btn7, .prev2, .prev3, .prev4, .prev5, .prev6, .prev7, .prev8{
		border-radius:14px;
	...
	.permit{
            font-size:30px; padding:10px;width:90%;
     }
...
<% } %>
        <section>
           ...
           <div style="text-align:center">
            ...
            <br/>
            <br/>
            <table class="catetable" style="font-size:30px;">
    		...
    		<table style="border:1px solid rgb(209, 209, 209);width:80%;margin:10px auto;border-spacing:0px;border-radius:5px;">
   			...
   			<tr><td>
    		<div style="margin :0px auto;font-size:28px;">
