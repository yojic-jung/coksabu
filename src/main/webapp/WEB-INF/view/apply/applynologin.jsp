...
<meta property="og:url" content="https://www.coksabu.com/apply">
    ...
    <style>
        ...
        .bar8{
        width:590px; background:rgb(44, 184, 26); border-radius:4px;padding:4px;
        }
        .content{
	...
	.btn1, .btn2, .btn3, .btn4 , .btn5, .btn6 ,.btn7 , .btn8, .prev2, .prev3, .prev4, .prev5, .prev6, .prev7, .prev8{
		border-radius:4px;
	...
	.locale-main{
		font-size:13px; color:gray; padding:7px;
		height:35px;
	}
	.locale{
	display:none;font-size:13px; color:gray; padding:7px;height:35px;
	}
	.locale3{
...
<% } %>
        <section>
            ...
            <div style="padding:30px;min-height:800px;">
            <div style="width:800px; background:white; margin: auto; padding:20px;">
            <div>
            <form:form method="post" commandName="memberInfo" onSubmit="return CheckForm(this)">
            
            <div class="step1">
            
            <div style="margin-left:100px;font-family:'JejuGothic';font-size:15px;">1단계</div>
            <br/>
            <div class="bar">
            <div class="bar1"></div>
            </div>
            ...
            <div style="margin-left:100px;font-family:'JejuGothic';font-size:15px;">2단계</div>
            <br/>
            <div class="bar">
            <div class="bar2"></div>
            </div>
            ...
            <div class="step3" >
            <div style="margin-left:100px;font-family:'JejuGothic';font-size:15px;">3단계</div>
            <br/>
            <div class="bar">
            <div class="bar3"></div>
            </div>
            ...
            <tr><td>
            학년&nbsp;
				<select id="grade" name="grade" style="padding:10px;color:gray; font-size:15px; font-family:'JejuGothic'">
					<option>--선택--</option>
				...
				&nbsp;&nbsp;&nbsp;
				성별&nbsp;
				<select name="sexual" style="padding:10px; font-size:15px;color:gray; font-family:'JejuGothic'">
                        	<option>남</option>
                        	<option>여</option>
                </select>
			</td></tr>
            ...
            <div class="step4" >
            <div style="margin-left:100px;font-family:'JejuGothic';font-size:15px;">4단계</div>
            <br/>
            <div class="bar">
            <div class="bar4"></div>
            </div>
            ...
            <div class="step5" >
            <div style="margin-left:100px;font-family:'JejuGothic';font-size:15px;">5단계</div>
            <br/>
            <div class="bar">
            <div class="bar5"></div>
            </div>
            ...
            <div class="step6" >
            <div style="margin-left:100px;font-family:'JejuGothic';font-size:15px;">6단계</div>
            <br/>
            <div class="bar">
            <div class="bar6"></div>
            </div>
            ...
            <div class="step7" >
            <div style="margin-left:100px;font-family:'JejuGothic';font-size:15px;">7단계</div>
            <br/>
            <div class="bar">
            <div class="bar7"></div>
            </div>
            ...
            <span style="color:gray; font-size:14px; font-family:'JejuGothic'">수업기준&nbsp;
                      <select name="month" class="price-standard" style="height:35px;">
                      ...
                      &nbsp;&nbsp;회당 수업시간  
                      <select name="gawetime" class="price-time" style="height:35px;">
                          <option>60분</option>
                          <option>90분</option>
                          <option>2시간</option>
           ...
           <span style="color:gray; font-size:14px;font-family:'JejuGothic'">가격&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<select class="price1" id="price1" name="price1" style="height:35px;">
                		...
                		~
                		<select class="price2" id="price2" name="price2" style="height:35px;">
                    		<option value="10만원">10만원</option>
                    		<option value="20만원">20만원</option>
                    		<option value="30만원">30만원</option>
                    		<option value="40만원">40만원</option>
            ...
            <textarea style="font-size:15px; line-height:150%;" name="message" class="message" rows="6" cols="60"></textarea>
            <input type="text" name="visible" value="1" style="display:none;" />
            </div>
            </td></tr>
            </table>
            <br/>
           	<span class="btn7">다음단계</span><span class="prev7">이전단계</span>
            <br/><br/>
            </div>
            </div>
            ...
            <div class="step8" >
            <div style="margin-left:100px;font-family:'JejuGothic';font-size:15px;">8단계</div>
            <br/>
            <div class="bar">
            <div class="bar8"></div>
            </div>
            <div class="content">
            <br/>
            	회원가입을 안하신 경우 아래 정보를 입력해주세요.<br/>
            <br/>
            <br/>
            <table class="catetable">
            
            <tr><td>
            <input type="text" name="email" class="permit" id="email" placeholder="이메일" />
    		</td></tr>
    		
    		<tr><td>
    		<input type="password" class="permit" id="password" placeholder="비밀번호(문자, 숫자, 특수문자 포함 8-15자)" name="password"/>
    		</td></tr>
    		
    		<tr><td>
    		<input class="permit" id="password2" type="password" placeholder="비밀번호 확인" />
    		</td></tr>
    ...
    <input type="text" style="display:none;" class="permit name" id="name" placeholder="이름" name="name"/>
    <input type="text" style="display:none;" class="permit birth" id="birth"  name="birth"/>
    <input style="display:none;" class="phone" id="phone" placeholder="휴대폰 번호 (-)없이 " name="phone" value=""/>
    
            	<input type="submit" class="btn8" value="요청하기" /><span class="prev8">이전단계</span>
            <br/><br/>
            </div>
            </div>
 ...
 $(document).ready(function(){
	 ...
	 if(ex == 'exception'){
	   	alert("이메일 중복, 이미 가입된 정보가 있습니다. 로그인 후 신청 해주세요.");
	 }else if(ex == 'phone'){
	   	alert("휴대폰번호 중복, 이미 가입된 정보가 있습니다. 로그인 후 신청 해주세요.");
	 }else if(ex=='certify'){
