...
<link rel="stylesheet" href= "<c:url value="/resources/colorbox.css" />" />
	...
	.search{
			width:100px;padding:5px;color:orange;font-weight:bolder;
			font-size:18px;
	}
	...
	.locale{
	display:none;font-size:15px; color:gray; padding:5px;height:32px;
	}
	#name{
			color:dimgray;
			font-size:14px;
...
<body>
	...
	<section>
		...
		<td>
		<select class="locale-main" name="locale1" style="font-size:15px; height:32px;color:gray; padding:5px;">
             ...
             <select class="locale">
						...
						<td class="search">
                       	 ...
                       	 <td>
                        	<label style="font-size:15px;height:32px;cursor:pointer"><input class="cate1" type="radio" name="cate" value="수학"/>수학</label>&nbsp;&nbsp;
                        	<label style="font-size:15px;height:32px;cursor:pointer"><input class="cate2" type="radio" name="cate" value="외국어" />외국어</label>&nbsp;&nbsp;
                        	<label style="font-size:15px;height:32px;cursor:pointer"><input class="cate3" type="radio" name="cate" value="국어" />국어</label>&nbsp;&nbsp;
                        	<label style="font-size:15px;height:32px;cursor:pointer"><input class="cate4" type="radio" name="cate" value="사회" />사회</label>&nbsp;&nbsp;
                        	<label style="font-size:15px;height:32px;cursor:pointer"><input class="cate5" type="radio" name="cate" value="과학" />과학</label>&nbsp;&nbsp;
                        	<label style="font-size:15px;height:32px;cursor:pointer"><input class="cate6" type="radio" name="cate" value="예체능" />예체능</label>&nbsp;&nbsp;
                        	<label style="font-size:15px;height:32px;cursor:pointer"><input class="cate7" type="radio" name="cate" value="자소서/입시" />자소서/입시</label>&nbsp;&nbsp;
                        </td>
                        </tr>
                        <tr>
                        ...
                        <td>
                        	학년&nbsp;&nbsp;
                        	<select id="gradeform" name="grade" style="height:32px;font-size:15px; color:gray; padding:5px;">
                        	...
                        	&nbsp;&nbsp;&nbsp;&nbsp;
                        	학생성별&nbsp;&nbsp;
                        	<select id="sexualform" name="sexual" style="font-size:15px; color:gray; padding:5px;height:32px;">
                        		<option value="">무관</option>
                        ...
                        <div style="text-align:center;width:520px;margin-top:10px">
                        <input type="submit" value="검색" style="padding:6px;width:50px;background:orange;color:white;border:none;border-radius:4px;"/>
                        </div>
                        </form>
		</div>
		</div>
		 <hr/>
		 <div style="min-height:300px;width:80%; margin:10px auto; font-size:12px;">
...
<c:choose>
	...
	<div id="pst" style="border:1px solid silver;background:rgb(231, 231, 231);vertical-align:top;padding:15px; width:230px; margin:20px 15px;">
	</c:if>	
		
	<c:if test="${apply.visible!=0}">
	<div id="pst" style="border:1px solid silver;vertical-align:top;padding:15px; width:230px; margin:20px 15px;">
	</c:if>
		...
		<c:if test="${apply.visible==0}">
		<span style="font-weight:normal;font-size:14px;color: dimgray; float:right; clear:right;margin-right:10px;">
		모집마감</span>
		</c:if>
		...
		<div class="apply-read" style="display: none;">
			<div style="width:400px; min-height:250px; font-family:'JejuGothic';color:dimgray;background:rgb(252, 251, 251);">
				...
				<div style="width:400px; background:rgb(241, 241, 239);padding:10px;">
				<div style="margin:20px 0px 10px 0px; font-size:16px;text-align:center">희망 가격 ${apply.price1} ~ ${apply.price2}</div>
				<div style="margin:10px 0px 10px 0px; font-size:13px; text-align:center">(${apply.month}, 회당 ${apply.gawetime} )</div>
				</div>
				
				<div style="padding:20px; color:orange;line-height:150%;">${apply.message}</div>
				
				<div style="text-align:center;padding:30px;">
				<span class="applybtn" style="border-radius:5px; padding:5px; color:white;background: orange; cursor:pointer" >
				지원하기
	...
	<c:if test="${k%4!=3 && k == listModel.endRow-listModel.startRow}" >
	</tr>
	</c:if>
