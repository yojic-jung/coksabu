...
<table style="border-spacing:30px;">
	...
	<tr>	
		...
		<td><input type="text" class="price1" name="price1" style="background:#EAEAEA;" value="${pur.price1}" readonly/></td>
	</tr>
	<tr>
	...
	<tr style="display:none;">
		<td>구매자 이메일 : <input type="text" class="buyerEmail" name="buyerEmail" value="${pur.buyerEmail}" readonly/></td>	
		<td>판매자 이메일 : <input type="text" class="sellerEmail" name="sellerEmail" value="${pur.sellerEmail}" readonly/></td>
	</tr>
...
$(document).ready(function(){
	...
	$('.refund-cancel').click(function(){
		...
		if(name=="구매자, 판매자와 상담후 환불취소 의사를 모두 확인하였습니다."){
			...
			if(con2){
				$.ajax({
	    	  		  url:'./adminRefundCancel?orderId='+orderid,
	    	  		  type:'get',
