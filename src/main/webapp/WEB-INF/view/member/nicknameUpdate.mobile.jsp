...
<div>
	...
	<form method='post'  onSubmit='return CheckForm(this)'>
		<div class='content'>
			...
			<div style='font-size:30px; width:500px; margin:auto;padding-bottom:10px;'>
				<input id="nickname" type="text" name="nickname" value="${nickName}" />
			</div> 
<div style="font-size:30px; width:500px; margin:0px auto 30px auto;padding:15px;">구매 또는 판매 내역이 있는 회원의 경우, 닉네임 변경이 제한됩니다.</div>
