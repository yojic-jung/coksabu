...
<div class='content'>
<div style='font-size:35px; width:650px; margin:auto;line-height:300%;'> 
<div style="margin:20px 0px">본인 명의 계좌를 입력해주시기 바랍니다.</div>
<div style="margin:20px 0px">예금주 <input class="depositor" style="font-size:35px;padding:10px; width:200px" type='text' value="${account.name}" disabled/></div>
<div style="margin:20px 0px">은행명 
<select class="account" style="padding:10px; width:250px;font-size:35px;" name="account">
			<option>--선택--</option>
			<option>농협</option>
			<option>국민은행</option>
			<option>신한은행</option>
