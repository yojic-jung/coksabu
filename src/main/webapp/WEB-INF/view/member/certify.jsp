...
line-height:150%;
 ...
 .btn1, .btn2, .btn3{
        ...
        #output1{
        	width:180px;height:140px;margin-right:20px;
        }
        #output2, #output3{
        	width:180px;height:140px;margin-right:20px;
        }
        ...
        .del1, .del2, .del3{
        	padding:5px; background:black; color:white;
        	border-radius:10px;
        	font-size:10px;
        	cursor:pointer;
        }
        ...
        .example1{
        	width:180px; height:100px; margin-right:30px;
        }
        .example2,.example3{
        	width:90px; height:100px;margin-right:30px;
        }
        .certi{
...
<div class="title1">본인/학력인증</div>
			...
			<table style="font-size:12px;font-weight:bolder;">
				...
				<div style="font-size:13px;text-align:center;color:orange;margin:10px;line-height:150%;">
 ...
 <br/>
        <div class="img-div" style="width:600px; margin:auto;">
        </div>
        ...
        <div  style="width:610px; margin:auto;">
         ...
         <br/>
        <div style="text-align:center;color:gray; font-size:12px;">이미지를 취소하고 싶은경우 이미지를 클릭하면 됩니다.</div>
...
$(document).ready(function(){
	...
	if(imgPath!=''){
		for(var i=0; i<img.length; i++){
    		...
    		$('.img-div').append('<img id="'+name+'" style="width:180px;" src=""/>');
    		$(delDiv).append(del);
    		var nameId = "#"+name;
